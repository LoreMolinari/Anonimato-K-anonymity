...
import pandas as pd
from utils.loss_metrics_adult import categorical_loss_metric_adult
...
def samarati(
    ...
    loss_metric = categorical_loss_metric_adult(solution.loc[:, lattice.quasi_id], leaves_num, lattice.hierarchies, final_sup)
